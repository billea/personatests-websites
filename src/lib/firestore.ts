...
export const sendFeedbackInvitations = async (
  ...
  try {
    ...
    // Note: Email sending is handled by Firebase Functions to prevent duplicates
    // The client-side EmailJS sending has been disabled to avoid duplicate emails
    console.log('📧 Email sending delegated to Firebase Functions - client-side sending disabled to prevent duplicates');
